...
export const SESSION_ID = process.env.SESSION_ID || 'Neiman_purple-ancient-fountain'; // e.g. "apple-river-stone"

// ─── Bot Identity ──────────────────────────────────────────────────────────────
export const BOT_NAME = process.env.BOT_NAME || 'Luthor MD';
export const BOT_VERSION = process.env.BOT_VERSION || '1.0.0';
export const OWNER_NUMBER = process.env.OWNER_NUMBER || '254788687886'; // your number, no +
